...
void AlgorithmLogic::ThreadInitCallback()
{
    ...
    for(int i=0;i<numRount;i++)
    {
        ...
        char bufer[20000];
                     ...
                     int64_t timeNum = int64_t(tx);
        if(i==0)
        {
            mysqlRecord="INSERT INTO "+tableName+"(userid, agentid, gametime,"
           ...
           sprintf(bufer,"VALUES(%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,'%s','%s','%s','%s','%s','%s','%s','%s')",
                   100,100,timeNum,100,100,100,
                   1,0,100,100,100,
        ...
        {
            string uuid=GlobalFunc::generateUUID();
            sprintf(bufer,",(%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,'%s','%s','%s','%s','%s','%s','%s','%s')",
                    100,100,timeNum,100,100,100,
                    1,0,100,100,100,
                    100,100,100,100,0,100,m_year,"ok",
                    "ok","ok","ok","ok","ok",
