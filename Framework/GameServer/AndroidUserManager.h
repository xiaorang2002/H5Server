...
public:
    void Init(tagGameInfo* pGameInfo, tagGameRoomInfo * pGameRoomInfo, ILogicThread* pILogicThread);
    bool LoadAndroidParam(int32_t agentid,int32_t currency);
...
protected:
    ...
    STD::Random									m_random;
	vector<double_t>							m_androidEnterPercentageVec;
private:
//#if 0
