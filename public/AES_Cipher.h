...
public:
    ...
    int encrypt(const unsigned char* src, uint32_t src_len, unsigned char* dest, uint32_t& dest_len);
    int decrypt(const unsigned char* src, uint32_t src_len, unsigned char* dest, uint32_t& dest_len);
private:
