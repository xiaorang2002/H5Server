...
public:
    ...
    int64_t GetLong(const char* lpszKeyName,int ndefVal=0)
    {
    ...
    int64_t GetLong(const char* lpszSection, const char* lpszKeyName, int64_t ndefVal=0)
    {
...
protected: // 内部文件操作.
	...
	*/
    ...
    int64_t GetIniKeyInt(const char *lpszSection, const char *lpszKey,int64_t default_value=0)
    {
