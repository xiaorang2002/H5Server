...
public:
                                              ...
                                              ::Fish::FishBasicData* pBasicData)
    {
        ...
        */
        ...
        do
        {
            ...
            ::Fish::FishType* fishtype = pBasicData->mutable_fishtype();
                                              ...
                                              ::Fish::FishShoalInfo* pShoalInfo)
    {
        ...
        */
        ...
        do
        {
            if (!pShoalInfo) break;
            // try to serial the special data to the protobuf content.
            ::Fish::FishType* fishtype = pShoalInfo->mutable_fishtype();
            fishtype->set_type(cmdData.fishType.type);
            fishtype->set_king(cmdData.fishType.king);
    ...
    */
    ...
    static unsigned short encodeFishSwimmingPattern(const FishSwimmingPattern& cmdData,
                                                    ::Fish::FishSwimmingPattern* pPattern)
    {
        /*
        ...
        */
        ...
        do
        {
            if (!pPattern) break;
            // try to serial the special data to the protobuf content.
            ::Fish::FishType* fishtype = pPattern->mutable_fishtype();
            fishtype->set_type(cmdData.fishType.type);
            fishtype->set_king(cmdData.fishType.king);
            ...
            {
                ::Fish::FishSwimmingParam* param = pPattern->add_paramitem();
    ...
    */
    ...
    static unsigned short encodeFishSwimmingParam(const FishSwimmingParam& cmdData,
                                                  ::Fish::FishSwimmingParam* pSwimParam)
    {
        /*
        // PathType pathType; 4
        // short speed; 10
    ...
    */
    ...
    static unsigned short encodeProduceFish(const FishProduceData& fishProduceData,
                                            ::Fish::FishProduceData* pProduceData)
    {
        /*
        if (bufferSize < 11) {
            return 0;
        ...
        */
        ...
        do
        {
            ...
            ::Fish::FishType* fishType = pProduceData->mutable_fishtype();
    ...
    */
    ...
    static unsigned short encodeProduceFishShoal(FishProduceData& fishProduceDataShoal,
                                                 ::Fish::CMD_S_ProduceFishShoal* pSceneShoal)
    {
        /*
        if (bufferSize < 5) {
            return 0;
    ...
    static unsigned short encodeProduceFishArray(const CMD_S_ProduceFishArray& cmdData,
                                                 ::Fish::CMD_S_ProduceFishArray* pFishArray)
    {
        /*
        if (bufferSize < 7) {
            return 0;
    ...
    static unsigned short encodeProduceFishArray(unsigned char* buffer, unsigned short bufferSize,const CMD_S_ProduceFishArray& cmdData)
    {
        ...
        do
        {
            ::Fish::CMD_S_ProduceFishArray fishArray;
    ...
    */
    ...
    static unsigned short encodeProduceFishes(const FishProduceDataMap& produceFishes,::Fish::CMD_S_ProduceFish* pSceneFishes, const CMD_S_HaiLongWangInfo& haiLongWangInfo)
    {
        // get byte size.
        int bytesize = 0;
        do
        {
			...
			bool bHaveHaiLongWang = false; // 是否有海龙王出现
            ...
            {
                p = iter->second;
                if (p->getFishKind().fishType.type == 50) //海龙王
                {
...
//            }
            ...
            if (bHaveHaiLongWang)
            {
                ::Fish::CMD_S_HaiLongWangInfo *hailongwang = pSceneFishes->mutable_longwanginfo();
                hailongwang->set_status(haiLongWangInfo.status);
                hailongwang->set_nlife(haiLongWangInfo.nlife);
            }
            // encodeProduceFish
            iter = leaderFishes.begin();
            while (iter != leaderFishes.end())
            {
                p = iter->second;
                ::Fish::FishProduceData* pProduceData = pSceneFishes->add_producefish();
            ...
            {
                p = fishShoal.at(i);
                ::Fish::CMD_S_ProduceFishShoal* pFishShoal = pSceneFishes->add_fishshoal();
    ...
    static unsigned short encodeProduceFishes(unsigned char* buffer,
                                              ...
                                              const FishProduceDataMap& produceFishes, const CMD_S_HaiLongWangInfo& haiLongWangInfo)
    {
        int bytesize = 0;
        try
        {
            ::Fish::CMD_S_ProduceFish sceneProduceFishes;
            encodeProduceFishes(produceFishes,&sceneProduceFishes, haiLongWangInfo);
    ...
    */
    ...
    static unsigned short encodeFishArrayParam(const CMD_S_GameConfig& gameConfig,
                                               ::Fish::FishArrayParam* pFishArrayParam)
    {
        int bytesize = 0;
        do
        {
            if (!pFishArrayParam) break;
            ::Fish::FishArrayParam1* param1 = pFishArrayParam->mutable_param1();
            if (param1)
            {
                ...
                for (int i=0;i<kindCount;i++)
                {
                    ...
                    for (int j=0;j<nBigCount;j++) {
                        ::Fish::FishType* fishType = param1->add_big_fish();
            ...
            ::Fish::FishArrayParam2* param2 = pFishArrayParam->mutable_param2();
            if (param2)
            {
                ...
                for (int i=0;i<nBigCount;i++) {
                    ::Fish::FishType* fishType = param2->add_big_fish();
            ...
            ::Fish::FishArrayParam3* param3 = pFishArrayParam->mutable_param3();
            if (param3)
            {
                ...
                for (int i=0; i<boomCount; i++) {
                    ::Fish::CirboomParam* param = param3->add_param();
            ...
            ::Fish::FishArrayParam4* param4 = pFishArrayParam->mutable_param4();
            if (param4) {
                ...
                for (int i=0;i<boomCount;i++) {
                    ::Fish::CirboomParam* param = param4->add_param();
            ...
            ::Fish::FishArrayParam5* param5 = pFishArrayParam->mutable_param5();
            if (param5) {
                ...
                for (int i=0;i<boomCount;i++)
                {
                    ...
                    for (int i=0;i<paramCount;i++) {
                        ::Fish::Circle2Param* param = param5->add_param();
            ...
            ::Fish::FishArrayParam6* param6 = pFishArrayParam->mutable_param6();
            if (param6) {
                ...
                for (int i=0;i<paramCount;i++)
                {
                    ...
                    for (int j=0;j<crossCount;j++) {
                        ::Fish::CrossoutParam* param = param6->add_param();
            ...
            ::Fish::FishArrayParam7* param7 = pFishArrayParam->mutable_param7();
            if (param7) {
                ...
                for (int i=0;i<paramCount;i++) {
                    ::Fish::CenterOutParam* param = param7->add_param();
            ...
            ::Fish::FishArrayParam8* param8 = pFishArrayParam->mutable_param8();
            if (param8)
            {
                ...
                for (int i=0;i<bigkindCount;i++)
                {
                    ...
                    {
                        ::Fish::FishType* fishType = param8->add_big_fish();
                        fishType->set_king(pType[j].king);
                        fishType->set_type(pType[j].type);
                    }
                }
    ...
    static unsigned short encodeGameConfig(const CMD_S_GameConfig& gameConfig,
                                           ::Fish::CMD_S_GameConfig* pGamecfg)
    {
        int bytesize = 0;
        do
        {
            ...
            ::Fish::FishArrayParam* pArrayParam = pGamecfg->mutable_fisharrayparam();
    ...
    // 动态换坐位玩法.
            ...
            ::Fish::CollectData* collectData = pGamecfg->mutable_collectdata();
            ...
            ::Fish::MsyqData* pMsyqdata = pGamecfg->mutable_msyqdata();
            ...
            for (int i=0;i<pplCount;i++) {
                ::Fish::PplData* pplData = pGamecfg->add_ppldata();
                pplData->set_isplaying(gameConfig.pplData.isPlaying);
                pplData->set_hits(gameConfig.pplData.hits);
            }

            ::Fish::PplXmlConfig* pplXmlConfig = pGamecfg->mutable_pplxmlconfig();
    ...
    static unsigned short encodeGameScene(unsigned char* buffer, unsigned short bufferSize, const CMD_S_GameScene& cmdData, const FishProduceDataMap& produceFishes,bool isChangescene, bool bBorebitStartRotate, const CMD_S_HaiLongWangInfo& haiLongWangInfo)
    {
        int bytesize = 0;
        do
        {
            ::Fish::CMD_S_GameScene gameScene;
            ...
            {
                ::Fish::FishSwimmingPattern* pPattern = gameScene.add_fishswimmingpattern();
            ...
            {
                ::Fish::FishShoalInfo* pShoalInfo = gameScene.add_fishshoal();
            ...
            // unsigned char sceneID; 3
            // unsigned char pause; 1
            ::Fish::CMD_S_GameConfig* pGamecfg = gameScene.mutable_gameconfig();
            ...
            ::Fish::CMD_S_ProduceFishArray* pFishArray = gameScene.mutable_fisharray();
            ...
            for(int i=0;i<MAX_PLAYERS;i++)
            {
                ...
                {
                    ::Fish::CMD_S_PlayerInfo *plays=gameScene.add_players();
				...
				{
                    ::Fish::CMD_S_SpecialFire *specials = gameScene.add_specialfire();
...
//                }
            ...
            if (produceFishes.size())
            {
                ...
                ::Fish::CMD_S_ProduceFish* pFishes = gameScene.mutable_fishes();
                int tempSize = encodeProduceFishes(produceFishes, pFishes, haiLongWangInfo);
                if (!tempSize) {
			...
			if (bHaveHaiLongWang)
			{
                ::Fish::CMD_S_HaiLongWangInfo *hailongwang = gameScene.mutable_longwanginfo();
				hailongwang->set_status(haiLongWangInfo.status);
				hailongwang->set_nlife(haiLongWangInfo.nlife);
			}
    ...
    static unsigned short encodeUserFire(unsigned char* buffer, unsigned short bufferSize, const CMD_S_UserFire& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_UserFire userFire;
            ::Fish::CMD_C_UserFire* pUserFire = userFire.mutable_c();
    ...
    */
    ...
    static unsigned short encodeGameplay(unsigned char* buffer, unsigned short bufferSize, const CMD_S_Gameplay& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_Gameplay gamePlay;
            ::Fish::CMD_C_Gameplay* pGamePlay = gamePlay.mutable_c();
    ...
    */
    ...
    static unsigned short encodeExchangeScore(unsigned char* buffer, unsigned short bufferSize, const CMD_S_ExchangeScore& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_ExchangeScore exchangeScore;
    ...
    */
    ...
    static bool decodeExchangeScore(CMD_C_Exchange_Score& exchangeScore, const unsigned char* buffer, unsigned short bufferSize)
    {
        ...
        try
        {
            ...
            ::Fish::CMD_C_ExchangeScore fishScore;
    ...
    static unsigned short encodeCatchFish(unsigned char* buffer, unsigned short bufferSize, const CMD_S_CatchFish& cmdData, const FISH_ID* fishIDs, unsigned short fishCount,const FISH_ID* hits,unsigned short hitcount, const CMD_S_HaiLongWangInfo& haiLongWangInfo, bool bCatchHaiLongWang = false)
    {
        /*
        ...
        */
        ...
        do
        {
            ...
            ::Fish::CMD_S_CatchFish catchFish;
			...
			{
                ::Fish::CMD_S_HaiLongWangInfo *hailongwang = catchFish.mutable_longwanginfo();
				hailongwang->set_status(haiLongWangInfo.deathstatus);
				hailongwang->set_nlife(haiLongWangInfo.deathlife);
			}
    ...
    */
    ...
    static unsigned short encodeSwitchScene(unsigned char* buffer, unsigned short bufferSize, const CMD_S_SwitchScene& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_SwitchScene switchScene;
    ...
    static unsigned short encodeLockFish(unsigned char* buffer, unsigned short bufferSize, const CMD_S_LockFish& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_LockFish lockfish;
            ::Fish::CMD_C_LockFish* cc = lockfish.mutable_c();
    ...
    static unsigned short encodeUnlockFish(unsigned char* buffer, unsigned short bufferSize, const CMD_S_UnlockFish& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_UnlockFish unlockfish;
    ...
    static unsigned short encodePauseFish(unsigned char* buffer, unsigned short bufferSize, const CMD_S_PauseFish& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_PauseFish pausefish;
    ...
    static unsigned short encodeWashPercent(unsigned char* buffer, unsigned short bufferSize, const CMD_S_WashPercent& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_S_WashPercent washPercent;
	...
	static unsigned short encodeSpecialFireEnd(unsigned char* buffer, unsigned short bufferSize, const CMD_S_SpecialFireEnd& cmdData)
	{
		...
		do
		{
            ::Fish::CMD_S_SpecialFireEnd specialFireEnd;
	...
	static unsigned short encodeBorebitStartRotate(unsigned char* buffer, unsigned short bufferSize, const CMD_S_StartRotate& cmdData)
	{
		...
		do
		{
            ::Fish::CMD_S_StartRotate startRotate;
	...
	static bool decodeSpecialRotate(CMD_C_SpecialRotate& cmdData, const unsigned char* buffer, unsigned short bufferSize)
	{
		...
		try
		{
			...
			if ((!buffer) || (!bufferSize)) throw;
            ::Fish::CMD_C_SpecialRotate specialRotate;
	...
	static unsigned short decodeSpecialRotate(unsigned char* buffer, unsigned short bufferSize, const CMD_S_SpecialRotate& cmdData)
	{
		...
		do
		{
            ::Fish::CMD_S_SpecialRotate specialRotate;
    ...
    static unsigned short encodeDynamicChair(unsigned char* buffer, unsigned short bufferSize, const CMD_C_DynamicChair& cmdData)
    {
        ...
        */
        ...
        do
        {
            ::Fish::CMD_C_DynamicChair dynamicChair;
    ...
    static unsigned short encodeDynamicChair(unsigned char* buffer, unsigned short bufferSize, const CMD_S_DynamicChair& cmdData)
    {
        ...
        do
        {
            ::Fish::CMD_S_DynamicChair dynamicChair;
            dynamicChair.set_newchairid(cmdData.newChairID);
