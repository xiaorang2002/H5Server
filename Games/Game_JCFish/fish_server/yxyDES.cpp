...
yxyDESClone::yxyDESClone()
{}
yxyDESClone::~yxyDESClone()
{}
void yxyDESClone::InitializeKey(string s)
{
...
string yxyDESClone::HexCharToBinary(char ch)
{
        switch(ch)
        {
                case '0':
...
string yxyDESClone::HexIntToBinary(int i)
{
        switch(i)
        {
                case 0:
...
string yxyDESClone::BinaryToString(char* szSource,int len,bool bType)
{
...
void yxyDESClone::CreateSubKey(char* sz)
{
        char szTmpL[28] = {0};
        char szTmpR[28] = {0};
        char szCi[28] = {0};
...
void yxyDESClone::EncryptData(string s)
{
        char sz_IP[64] = {0};
        char sz_Li[32] = {0};
        char sz_Ri[32] = {0};
...
void yxyDESClone::DecryptData(string s)
{
        char sz_IP[64] = {0};
        char sz_Li[32] = {0};
        char sz_Ri[32] = {0};
...
void yxyDESClone::FunctionF(char* sz_Li,char* sz_Ri,int iKey)
{
        char sz_48R[48] = {0};
        char sz_xor48[48] = {0};
        char sz_P32[32] = {0};
...
void yxyDESClone::InitialPermuteData(string s,char* Return_value,bool bType)
{
...
void yxyDESClone::ExpansionR(char* sz,char* Return_value)
{
        char sz_48ER[48] = {0};
        for(int i=0;i<48;i++)
        {
...
void yxyDESClone::XOR(char* sz_P1,char* sz_P2,int len,char* Return_value)
{
...
string yxyDESClone::CompressFuncS(char* sz_48)
{
        char sTmp[8][6] = {0};
        string sz_32 = "";
        for(int i=0;i<8;i++)
...
void yxyDESClone::PermutationP(string s,char* Return_value)
{
        char sz_32bits[32] = {0};
        for(int i=0;i<32;i++)
        {
...
int yxyDESClone::SingleCharToBinary(char ch)
{
        if(ch == '1')
                return 1;
        else
...
char yxyDESClone::SingleBinaryToChar(int i)
{
        if(i == 1)
                return '1';
        else
...
void yxyDESClone::SetCiphertext(char* value)
{
        memcpy(szCiphertext,value,16);
}
char* yxyDESClone::GetCiphertext()
{
        return szCiphertext;
}

void yxyDESClone::SetPlaintext(char* value)
{
        memcpy(szPlaintext,value,8);
}
char* yxyDESClone::GetPlaintext()
{
        return szPlaintext;
}
//any length
void yxyDESClone::EncryptAnyLength(string szSource)
{
...
string yxyDESClone::FillToEightBits(string sz)
{
...
char* yxyDESClone::GetCiphertextAnyLength()
{
        return szFCiphertextAnyLength;
}

void yxyDESClone::DecryptAnyLength(string szSource)
{
        int iLength = szSource.length();
...
char* yxyDESClone::GetPlaintextAnyLength()
{
        return szFPlaintextAnyLength;
}

void yxyDESClone::CleanPlaintextMark(int iPlaintextLength)
{
