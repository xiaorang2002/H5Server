...
# debug:
# qmake Game_DntgFish.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug

# release:
# qmake Game_DntgFish.pro -spec linux-g++
...
# DNTGFISH
DEFINES += __DNTG__
TARGET  = Game_dntgfish

DEFINES += GAME_DNTGFISH_LIBRARY
...
DISTFILES += \
    ../../proto/src/dntgfish.Message.proto
