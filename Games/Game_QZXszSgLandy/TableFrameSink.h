...
private:
    ...
    uint8_t                 m_cbSGCard[GAME_PLAYER][MAX_COUNT];					//三公牌数据
//    uint8_t                 m_cbSGCardRecord[GAME_PLAYER][MAX_COUNT];           //三公牌数据存入数据库
    uint8_t                 m_cbSGRecord[GAME_PLAYER*MAX_SENDCOUNT];           //三公牌数据和庄家号（最后一位是庄家号）存入数据库
