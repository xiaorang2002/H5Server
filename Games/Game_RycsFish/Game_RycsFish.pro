...
# debug:
# qmake Game_RycsFish.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug

# release:
# qmake Game_RycsFish.pro -spec linux-g++
...
# RYCSFISH
DEFINES += __RYCS__
TARGET  = Game_rycsfish

DEFINES += GAME_RYCSFISH_LIBRARY
...
SOURCES += \
    ...
    fish_server/CTableFrameSink.cpp \
...
DISTFILES += \
    ../../proto/src/rycsfish.Message.proto
