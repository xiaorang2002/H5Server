...
bool CAndroidUserItemSink::ReadConfigInformation()
{
	...
	//设置文件名
	if (!boost::filesystem::exists("./conf/slwh_config.ini"))
	{
		LOG(WARNING) << "conf slwh_config.ini not exists";
		return false;
	}

	boost::property_tree::ptree pt;
	boost::property_tree::read_ini("./conf/slwh_config.ini", pt);
