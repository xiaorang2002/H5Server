...
# debug:
# qmake Game_LKFish.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug

# release:
# qmake Game_LKFish.pro -spec linux-g++
...
DISTFILES += \
    ../../proto/src/lkfish.Message.proto
