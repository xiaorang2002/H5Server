...
public:
    ...
    bool FillTable(CMD_S_RoundResult_Tag &SceneOneEnd,int32_t wChairID);
    ...
    void CountIsWin(vector<resultStr> &resultArrVec, CMD_S_RoundResult_Tag &SceneOneEnd,int32_t allBet);
private:
    //初始化游戏数据
    void InitGameData();
