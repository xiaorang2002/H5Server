...
public:
    ...
    int64_t m_CurrentRobotAddGold[BET_ITEM_COUNT]; //当前机器人下注
	int m_ProbabilityWeight[6];		 //可下注百分比权重
    int64_t m_AddMaxGold[5];		 //最大下注筹码
	int m_ChouMaWeight[5];			 //筹码权重
    int64_t m_RobotAddGold[BET_ITEM_COUNT];		 //机器人龙虎和区域下注
