...
private:
    ...
    int8_t                 m_cbCallable[GAME_PLAYER][MAX_BANKER_MUL];//玩家可用的叫庄倍数
    uint8_t                 m_cbJettonable[GAME_PLAYER][MAX_JETTON_MUL];//玩家可用的下注倍数
private:
    static uint8_t			m_cbJettonMultiple[MAX_JETTON_MUL];					//下注倍数1, 5, 10, 15, 20
    static uint8_t			m_cbBankerMultiple[MAX_BANKER_MUL];					//叫庄倍数 1, 2, 4
