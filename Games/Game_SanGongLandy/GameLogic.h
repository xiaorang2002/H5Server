...
public:
    ...
    //根据点数获取牌的数据
    bool GetMatchPointCard(int32_t iPoint,uint8_t cbCardData[MAX_COUNT], uint8_t byCardDataArray[MAX_CARD_TOTAL]);
    bool GetResolvePointCard(string& sValue,uint8_t cbCardData[MAX_COUNT], uint8_t byCardDataArray[MAX_CARD_TOTAL]);
private:
