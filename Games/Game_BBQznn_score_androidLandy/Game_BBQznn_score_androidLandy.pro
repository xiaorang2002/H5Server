...
TARGET = Game_bbqznn_score_android
TEMPLATE = lib

DEFINES += GAME_BBQZNN_SCORE_ANDROID_LIBRARY
DESTDIR = ../../bin/
...
SOURCES += \
    ...
    ../../Framework/GameServer/ServerUserItem.cpp \
    ../../proto/BBQznn.Message.pb.cc \ 
...
DISTFILES += \
    ../../proto/src/BBQznn.Message.proto
