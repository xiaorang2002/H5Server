...
{
     //库存权重数组
    UserProbabilityItem vProbability[4];    //三组净分概率组
    ...
    int32_t     m_testMarry;                //是否开启测试玛利
    int32_t     m_marryIndex;               //测试玛利
    int32_t     m_marryList[4];             //中间的icon

    int32_t     m_testBibei;
    int32_t     m_bibiList[2];
    ...
    double      stockweak;
    int64_t     m_BestWinNum;
    vector<int32_t>     m_vControlAgentid;
	tagAllConfig()
    {
        ...
        nKickOutTime = 120;
        stockweak=1.0;
        m_BestWinNum = 10000000;
        m_vControlAgentid.clear();
    }
};
