...
public:
    BetArea();
    ~BetArea();
    void SetBetItem(int32_t idx,int64_t betValue);
    int32_t GetBetItem(int32_t idx);
    void SetJettonScore(int index, int64_t Score, int64_t bankerScore, bool isanzhuo); //chou ma he ya zhu
